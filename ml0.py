...
class NeuralNetwork:
    def __init__(self, x,y):
        self.input = x
        self.weights1= np.random.rand(self.input.shape[1],1) # considering we have 4 nodes in the hidden layer
        self.y = y
    ...
    def backprop(self):
        ...
        d_weights1 = np.dot(self.input.T, 2*(self.y -self.output)*sigmoid_derivative(self.layer1))
